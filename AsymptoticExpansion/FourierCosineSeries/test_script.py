...
# N2 = 30  #  >12 since we use the reversion =10
...
print("w",wCFS)
print("absolute error for implied volatility:",np.abs(wCFS-sigmaBSM))
print("***************************************************************************")
...
CFS_expansion_utils.testifyExchangeSumOrder(S0,strike,T,r,q,sigmaBSM,a,b,N1,N2,quantile)
