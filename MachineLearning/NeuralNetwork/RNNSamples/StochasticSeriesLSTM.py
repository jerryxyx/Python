...
batchX_placeholder = tf.placeholder(tf.int32, [batch_size, truncated_backprop_length], name='input_placeholder')
...
cell = gen_multilayers_LSTM_cell(state_size,num_layers)
init_state = gen_multilayers_state_tuple(states_placeholder)
        ...
        for batch_idx, batch in enumerate(epoch):
            _total_loss, _train_step, _current_state = sess.run(
                ...
                feed_dict={
                    ...
                    states_placeholder: _current_state
                })
